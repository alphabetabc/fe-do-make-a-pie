const getLineTooltip=({title:e="",width:t=197,valueTitle:o="",data:i=[]})=>`<div style="width: ${typeof t=="number"?`${t}px`:t}; overflow:hidden;">
  <div style="clear:both; width:100%; height:28px;background:rgba(0, 0, 0, 0.9);line-height:28px; font-size: 14px">
    <span style="margin-left: 16px;">${e}</span>
    <span style="float:right; margin-right: 16px;">${o}</span>
  </div>
  <div style="clear:both;padding: 8px 0;width:100%;background:rgba(0, 0, 0, 0.5);">
    ${i.map(({legend:l,name:r,value:a})=>`
        <div style="margin:0 16px; width: '100%'; height: '24px';">
          <span style="width: 16px; height: '100%';">${l}</span>
          <span style="line-height: 24px; font-size: 12px">${r}</span>
          <span style="float:right; line-height: 24px; font-size: 12px">${a}</span>
        </div>
      `).join("")}
  </div>
</div>`;option={xAxis:{type:"category",data:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"]},yAxis:{type:"value"},tooltip:{formatter:`<div style="width: 295px; overflow:hidden;">
  <div style="clear:both; width:100%; height:28px;background:rgba(0, 0, 0, 0.9);line-height:28px; font-size: 14px">
...
</div>`},series:[{data:[820,932,901,934,1290,1330,1320],type:"line",textStyle:{fontSize:12,fontWeight:"bolder"},smooth:!0,showAllSymbol:!0,showSymbol:!0,symbolSize:22,label:{show:!0,distance:4,position:["-300%","-110%"],formatter:function(e){var t=e.value||0;return"{color1|"+t*100+"}{color2| % }"},rich:{color1:{color:"#fff",backgroundColor:"black",borderColor:"#FAAE29",border:1,lineHeight:24,height:24,padding:[0,6,0,6],borderWidth:1,borderRadius:[3,0,0,3]},color2:{color:"#fff",backgroundColor:"#FAAE29",borderColor:"#FAAE29",lineHeight:24,height:24,borderWidth:1,borderRadius:[0,3,3,0],padding:[0,4,0,1]}}},itemStyle:{lineStyle:{width:2,color:{type:"linear",x:0,y:0,x2:0,y2:1,colorStops:[{offset:0,color:"#78ffc8"},{offset:.5,color:"#1ff39d"},{offset:1,color:"#125037"}],global:!1},shadowColor:"#000",shadowBlur:10,shadowOffsetY:40}}}]};
