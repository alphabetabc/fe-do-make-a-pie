let color=["#ffffff","#36fff6","#ffe93a","#67f95f"],oneArr=[{name:"地理信息中台",type:0,symbol:`image://data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAw8AAAKMCAYAAACtj4QUAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
MDM1OTI5MDE4OTI3XzY5X1swXYr85F0AAAAASUVORK5CYII=`,symbolSize:190,itemStyle:{color:{type:"linear",x:0,y:0,x2:0,y2:1,colorStops:[{offset:0,color:"#ffe93a"},{offset:1,color:"#36fff6"}],global:!1}}}],erArr1=[{name:"市城市管理局",type:1},{name:"科大讯飞",type:2},{name:"市水利局",type:1}],erArr2=[{name:"市政法委",type:1},{name:"市自然资源和规划局",type:1},{name:"市生态环境局",type:1},{name:"市大数据局",type:3}],erArr=[...erArr1],allArr=[],type=1,dataArr=[];function setSymbolSize(){allArr=[],type==1?(erArr=[...erArr1],allArr=[...oneArr,...erArr1]):(erArr=[...erArr2],allArr=[...oneArr,...erArr2]),allArr.forEach((n,A)=>{n.type>0?(n.symbolSize=50,n.symbol="path://M544 552.325V800a32 32 0 0 1-32 32 31.375 31.375 0 0 1-32-32V552.325L256 423.037a32 32 0 0 1-11.525-43.512A31.363 31.363 0 0 1 288 368l224 128 222.075-128a31.363 31.363 0 0 1 43.525 11.525 31.988 31.988 0 0 1-11.525 43.513L544 551.038z m0 0,M64 256v512l448 256 448-256V256L512 0z m832 480L512 960 128 736V288L512 64l384 224z m0 0",n.itemStyle={color:color[n.type]}):type?n.symbolSize=180:n.symbolSize=200,n.label={normal:{show:!0,position:"bottom",distance:10,color:color[n.type]}}})}setSymbolSize();function group(n,A){const C=[],{length:g}=n;return n.forEach((B,I)=>{const Q=90-(360/g).toFixed(2)*(I+1),E=Math.cos(Q*Math.PI/180).toFixed(2)*A,D=Math.sin(Q*Math.PI/180).toFixed(2)*A,w=Math.cos(Q*Math.PI/180).toFixed(2)*(A-5),o=Math.sin(Q*Math.PI/180).toFixed(2)*(A-5),h=Math.cos(Q*Math.PI/180).toFixed(2)*(A-30),K=Math.sin(Q*Math.PI/180).toFixed(2)*(A-30);B.value=[E.toFixed(2),D.toFixed(2)],B.twoPoint=[[w.toFixed(2),o.toFixed(2)],[h.toFixed(2),K.toFixed(2)]],C.push(B)}),C}function linesConfig(n){const[A,C]=[[],[0,0]];return n.forEach(g=>{function B(I,Q){return[{coord:g.twoPoint[I]},{coord:g.twoPoint[Q],lineStyle:{color:color[g.type],curveness:g.type===3?.1:0},effect:{show:!1}}]}switch(g.type){case 0:break;case 1:A.push(B(0,1));break;case 2:A.push(B(1,0));break;case 3:A.push(B(0,1)),A.push(B(1,0));break}}),A}function generateData(n,A,C,g){let B=[];for(var I=0;I<n;I++)I%2===0?B.push({name:(I+1).toString(),value:A,itemStyle:{normal:{color:g,borderWidth:0}}}):B.push({name:(I+1).toString(),value:C,itemStyle:{normal:{color:"rgba(0,0,0,0)",borderWidth:0}}});return B}let dolitData=generateData(100,25,20,"rgb(126,190,255)"),threeData=generateData(6,40,10,"#2dc0c9");function getOption(n,A){return{backgroundColor:"#081c47",title:{text:`开启线图拖尾效果出现一卡一卡
因为圆使用的定时动画`,left:"center",textStyle:{color:"#fff"}},xAxis:{show:!1,type:"value",max:50,min:-51},grid:{top:10,bottom:10,left:10,right:10},yAxis:{show:!1,type:"value",max:50,min:-50},series:[{name:"节点",type:"graph",silent:!1,hoverAnimation:!1,cursor:"default",coordinateSystem:"cartesian2d",z:3,itemStyle:{normal:{shadowColor:"none"}},emphasis:{scale:!1},data:allArr},{name:"线图",type:"lines",hoverAnimation:!1,silent:!1,cursor:"default",coordinateSystem:"cartesian2d",polyline:!1,z:1,lineStyle:{width:2,type:"dashed",curveness:0},effect:{show:!0,period:4,trailLength:0,symbol:"arrow",symbolSize:6},emphasis:{lineStyle:{type:"dashed"}},data:dataArr},{name:"不动外圆",type:"pie",zlevel:4,silent:!0,radius:["60%","59%"],label:{normal:{show:!1}},labelLine:{normal:{show:!1}},data:dolitData},{type:"pie",name:"旋转圆",zlevel:20,silent:!0,radius:["50%","49%"],hoverAnimation:!1,startAngle:n,data:threeData,label:{normal:{show:!1}},labelLine:{normal:{show:!1}}},{name:"缩放圆",type:"pie",zlevel:4,silent:!0,radius:[A+1+"%",A+"%"],label:{normal:{show:!1}},labelLine:{normal:{show:!1}},data:dolitData}]}}let startAngle=50,[minradius,radius,maxradius]=[24,24,28],isBig=!0;function draw(){startAngle=startAngle-5,isBig?(radius=radius+.5,radius>maxradius&&(isBig=!1),type=1,setSymbolSize(),oneArr=group(oneArr,0),erArr=group(erArr,40),allArr=[...oneArr,...erArr],dataArr=linesConfig(allArr)):(radius=radius-.5,radius<minradius&&(isBig=!0),type=0,setSymbolSize(),oneArr=group(oneArr,0),erArr=group(erArr,40),allArr=[...oneArr,...erArr],dataArr=linesConfig(allArr));let n=getOption(startAngle,radius);myChart.setOption(n,!0)}timer=setInterval(draw,500);
