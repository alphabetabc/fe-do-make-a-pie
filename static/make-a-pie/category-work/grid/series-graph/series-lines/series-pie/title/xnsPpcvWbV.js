let color=["#ffffff","#36fff6","#ffe93a","#67f95f"],oneArr=[{name:"数据统一平台",type:0,symbol:`image://data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAw8AAAKMCAYAAACtj4QUAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
MDM1OTI5MDE4OTI3XzY5X1swXYr85F0AAAAASUVORK5CYII=`,symbolSize:150,itemStyle:{color:{type:"linear",x:0,y:0,x2:0,y2:1,colorStops:[{offset:0,color:"#ffe93a"},{offset:1,color:"#36fff6"}],global:!1}}}],erArr=[{name:"物管平台数据",type:1},{name:"指挥调度中心",type:3},{name:"经营决策系统数据",type:1},{name:"物流综合管控平台数据",type:1},{name:"其他业务数据",type:1},{name:"省营销数据",type:1},{name:"地市营销数据",type:1},{name:"行业专卖数据",type:1}],allArr=[...oneArr,...erArr],dataArr=[];allArr.forEach((n,A)=>{n.type>0&&(n.symbolSize=50,n.symbol="path://M544 552.325V800a32 32 0 0 1-32 32 31.375 31.375 0 0 1-32-32V552.325L256 423.037a32 32 0 0 1-11.525-43.512A31.363 31.363 0 0 1 288 368l224 128 222.075-128a31.363 31.363 0 0 1 43.525 11.525 31.988 31.988 0 0 1-11.525 43.513L544 551.038z m0 0,M64 256v512l448 256 448-256V256L512 0z m832 480L512 960 128 736V288L512 64l384 224z m0 0",n.itemStyle={color:color[n.type]}),n.label={normal:{show:!0,position:"bottom",distance:10,color:color[n.type]}}});function group(n,A){const Q=[],{length:g}=n;return n.forEach((B,I)=>{const C=90-(360/g).toFixed(2)*(I+1),E=Math.cos(C*Math.PI/180).toFixed(2)*A,D=Math.sin(C*Math.PI/180).toFixed(2)*A,w=Math.cos(C*Math.PI/180).toFixed(2)*(A-5),o=Math.sin(C*Math.PI/180).toFixed(2)*(A-5),h=Math.cos(C*Math.PI/180).toFixed(2)*(A-30),K=Math.sin(C*Math.PI/180).toFixed(2)*(A-30);B.value=[E.toFixed(2),D.toFixed(2)],B.twoPoint=[[w.toFixed(2),o.toFixed(2)],[h.toFixed(2),K.toFixed(2)]],Q.push(B)}),Q}function linesConfig(n){const[A,Q]=[[],[0,0]];return n.forEach(g=>{function B(I,C){return[{coord:g.twoPoint[I]},{coord:g.twoPoint[C],lineStyle:{color:color[g.type],curveness:g.type===3?.1:0},effect:{color:color[g.type]}}]}switch(g.type){case 0:break;case 1:A.push(B(0,1));break;case 2:A.push(B(1,0));break;case 3:A.push(B(0,1)),A.push(B(1,0));break}}),A}oneArr=group(oneArr,0),erArr=group(erArr,40),allArr=[...oneArr,...erArr],dataArr=linesConfig(allArr);function generateData(n,A,Q,g){let B=[];for(var I=0;I<n;I++)I%2===0?B.push({name:(I+1).toString(),value:A,itemStyle:{normal:{color:g,borderWidth:0}}}):B.push({name:(I+1).toString(),value:Q,itemStyle:{normal:{color:"rgba(0,0,0,0)",borderWidth:0}}});return B}let dolitData=generateData(100,25,20,"rgb(126,190,255)"),threeData=generateData(6,40,10,"#2dc0c9");function getOption(n,A){let Q={backgroundColor:"#081c47",title:{text:"数据统一管理平台",left:"center",textStyle:{color:"#fff"}},xAxis:{show:!1,type:"value",max:50,min:-51},grid:{top:10,bottom:10,left:10,right:10},yAxis:{show:!1,type:"value",max:50,min:-50},series:[{name:"节点",type:"graph",silent:!1,hoverAnimation:!1,cursor:"default",coordinateSystem:"cartesian2d",z:3,itemStyle:{normal:{shadowColor:"none"}},emphasis:{scale:!1},data:allArr},{name:"线图",type:"lines",hoverAnimation:!1,silent:!1,cursor:"default",coordinateSystem:"cartesian2d",polyline:!1,z:1,lineStyle:{width:2,type:"dashed",curveness:0},effect:{show:!0,period:8,trailLength:0,symbol:"arrow",symbolSize:6},emphasis:{lineStyle:{type:"dashed"}},data:dataArr},{name:"不动外圆",type:"pie",zlevel:4,silent:!0,radius:["50%","49%"],label:{normal:{show:!1}},labelLine:{normal:{show:!1}},data:dolitData},{type:"pie",name:"旋转圆",zlevel:20,silent:!0,radius:["40%","39%"],hoverAnimation:!1,startAngle:n,data:threeData,label:{normal:{show:!1}},labelLine:{normal:{show:!1}}},{name:"缩放圆",type:"pie",zlevel:4,silent:!0,radius:[A+1+"%",A+"%"],label:{normal:{show:!1}},labelLine:{normal:{show:!1}},data:dolitData}]};return console.log(Q),Q}let startAngle=50,[minradius,radius,maxradius]=[24,24,28],isBig=!0;function draw(){startAngle=startAngle-5,isBig?(radius=radius+.5,radius>maxradius&&(isBig=!1)):(radius=radius-.5,radius<minradius&&(isBig=!0));let n=getOption(startAngle,radius);myChart.setOption(n,!0)}timer=setInterval(draw,200);
