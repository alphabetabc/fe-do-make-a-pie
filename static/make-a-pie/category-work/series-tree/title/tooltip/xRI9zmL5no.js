option={title:{text:"委托审核接口调用"},tooltip:{trigger:"item",triggerOn:"mousemove"},series:[{type:"tree",roam:!0,layout:"orthogonal",orient:"LR",symbol:"emptyCircle",symbolSize:10,left:80,right:200,initialTreeDepth:5,label:{show:!0,offset:[10,0],align:"left"},tooltip:{formatter:function(e){return e.value.replace(/\/r\/n/g,"<br />")}},data:[{name:"委托审核",value:"角色：业务管理员、店务经理(助理)。",label:{offset:[-60,0]},children:[{name:"doSaveAudit",value:"保存委托审核信息。",label:{offset:[-30,-15]},children:[{name:`updateRentKeyByHousenumber
